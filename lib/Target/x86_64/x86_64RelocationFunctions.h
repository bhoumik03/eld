...
x86_64Relocator::Result relocTPOFF64(Relocation &pEntry,
                                     x86_64Relocator &pParent,
                                     RelocationDescription &RelocDesc);
x86_64Relocator::Result relocGOTTPOFF(Relocation &pEntry,
                                      x86_64Relocator &pParent,
                                      RelocationDescription &RelocDesc);
...
x86_64Relocator::Result relocDTPOFF64(Relocation &pEntry,
                                      x86_64Relocator &pParent,
                                      RelocationDescription &RelocDesc);
x86_64Relocator::Result relocGOT32(Relocation &pEntry, x86_64Relocator &pParent,
                                   RelocationDescription &RelocDesc);
x86_64Relocator::Result relocGOTOFF64(Relocation &pEntry,
                                      x86_64Relocator &pParent,
                                      RelocationDescription &RelocDesc);
x86_64Relocator::Result relocGOTPC32(Relocation &pEntry,
                                     x86_64Relocator &pParent,
                                     RelocationDescription &RelocDesc);
x86_64Relocator::Result relocSIZE32(Relocation &pEntry,
                                    x86_64Relocator &pParent,
                                    RelocationDescription &RelocDesc);
x86_64Relocator::Result relocSIZE64(Relocation &pEntry,
                                    x86_64Relocator &pParent,
                                    RelocationDescription &RelocDesc);
...
struct RelocationDescription x86RelocDesc[] = {
    ...
    {/*.func = */ &relocPCREL,
     ...
     /*.forceVerify = */ false},
    {/*.func = */ &relocGOTOFF64, /*.type = */ 25, /*.forceVerify = */ false},
    {/*.func = */ &relocGOTPC32, /*.type = */ 26, /*.forceVerify = */ false},
    ...
    {/*.func = */ &relocSIZE32, /*.type = */ 32, /*.forceVerify = */ false},
    {/*.func = */ &relocSIZE64, /*.type = */ 33, /*.forceVerify = */ false},
